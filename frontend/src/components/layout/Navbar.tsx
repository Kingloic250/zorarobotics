    ...
    >
              ...
              <AnimatePresence>
                {aboutOpen && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -8 }}
                    className="absolute top-full left-0 mt-2 w-48 bg-card backdrop-blur-xl border border-border p-2 space-y-1"
                  >
                    <Link
                      to="/about"
      ...
      {mobileMenuOpen && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="absolute top-full left-0 right-0 bg-card backdrop-blur-xl border-b border-border p-6 flex flex-col gap-5 md:hidden"
        >
          <Link
            to="/"
