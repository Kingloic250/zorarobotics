  ...
  const sectors = [
    {
      ...
      targetFr: 'Écoles, Universités, Organismes gouvernementaux d\'éducation, ONG et Chercheurs',
    },
    {
      icon: HeartPulse,
      titleEn: 'Healthcare',
      ...
      detailsEn: [
        ...
        'Supplied to UNDP, Kenya\'s Ministry of Health',
        'Capabilities: surveillance, data collection, disinfection',
      ],
      detailsFr: [
        ...
        'Fournis au PNUD, Ministère de la Santé du Kenya',
