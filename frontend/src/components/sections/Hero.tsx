...
export const Hero = () => {
  ...
  const content = {
    en: {
      ...
      headline2: 'to Africa.',
      description: 'Zorarobotics Pioneering AI and Robotics in Rwanda and across the continent, transforming Healthcare, Education, Industry and more.',
    ...
    fr: {
      ...
      description: 'Zorarobotics Pionniers de l\'IA et de la Robotique au Rwanda et sur tout le continent, transformant la Sant\u00e9, l\u2019\u00c9ducation, l\u2019Industrie et bien plus encore.',
