          ...
          >
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-6 py-4 bg-white/5 border border-white/10 text-white focus:outline-none focus:border-cyan/50 focus:bg-white/[0.08] transition-all appearance-none cursor-pointer font-mono text-xs">
                  {c.sectors.map((sector) => (
                    <option key={sector} className="bg-deep-bg">{sector}</option>
                  ))}
                </select>
              </div>
              ...
              <Button variant="primary" size="lg" className="w-full uppercase font-bold tracking-widest text-xs font-mono">
                {c.formSubmit}
              </Button>
            </form>
          </motion.div>
